...
#rightLayer #searchLayer #exportDimissionBtn{float: left;margin-top: 7px;}
...
function initListeners (argument) {
	...
	$("#exportDimissionBtn").click(function(){
		// 导出离职人员
		location.href = "../subscribe/callDimissionExport.action?projectId="+projectId;
	});
}
</script>
</head>
<body id="rightLayer">
<div id="searchLayer">
	<button id="exportDimissionBtn">导出离职人员</button>
