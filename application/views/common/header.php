        ...
        <div id="subNav">
            <div class="g-wrap">
                <div class="item about">
                    <a href="<?php echo site_url().'home/index/projectList#1';?>">项目信息<span></a>
                    <a href="<?php echo site_url().'home/index/newsList#1';?>">动态新闻<span></a>
                </div>
                <div class="item news">
                    <a href="<?php echo site_url().'home/index/newsList#2';?>">我要认购<span></a>
                    <a href="<?php echo site_url().'home/index/newsList#2';?>">未完成认购<span></a>
